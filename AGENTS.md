...
- domain/, policy/, and replay/ must not import langchain, langgraph, instructor, langsmith, playwright, or fastapi. Those layers are framework-free so the graded core stays independently testable and the framework stays swappable.
